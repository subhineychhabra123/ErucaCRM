...
namespace ErucaCRM.Service.Infrastructure
{
    public class TokenValidation : Attribute, IOperationBehavior, IOperationInvoker
    {
        ...
        private bool Authenticate()
        {
            ...
            if (!String.IsNullOrEmpty(UserToken))
            {
                ...
                if (!userBusiness.ValidateUserToken(UserToken)) { WebOperationContext.Current.OutgoingResponse.StatusCode = HttpStatusCode.Unauthorized; }
                else return true;
            }
