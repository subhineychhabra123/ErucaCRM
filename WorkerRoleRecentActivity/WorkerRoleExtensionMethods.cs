...
{
    public static class WorkerRoleExtensionMethods
 {
     public static DateTime ToDateTimeNow(this DateTime date)
     {
         if (date != new DateTime())
         {
             string offset = WorkerRoleRecentActivity.TimeZoneOffSet;
     ...
     public static string Encrypt(this Int32 toEncrypt)
     {
         ...
         byte[] keyArray;
         byte[] toEncryptArray = UTF8Encoding.UTF8.GetBytes(WorkerRoleRecentActivity.UserId + "-" + toEncrypt.ToString());
